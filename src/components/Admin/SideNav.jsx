...
import { HiOutlineHome, HiOutlineMail, HiOutlineChartBar, HiOutlineFolder, HiOutlineDatabase, HiOutlineUsers, HiOutlineChevronDown } from "react-icons/hi";
import { MdOutlineTrendingUp, MdKeyboardDoubleArrowLeft } from "react-icons/md"
        ...
        <div className="h-screen w-64 bg-gray-100">
            <div className="flex h-full flex-grow flex-col overflow-y-auto bg-white shadow">
                <div className="fixed z-30 bg-gray-100 flex justify-between h-14 w-64 space-x-4 p-3 shadow">
                    ...
                    {/* <MdKeyboardDoubleArrowLeft className="text-3xl cursor-pointer hover:text-pink-600" /> */}
                </div>
