                    ...
                    <div className="flex w-full items-center space-x-2">
                        ...
                        <div className="flex flex-col justify-between w-full">
                            ...
                            <div className="flex text-sm divide-x">
                                ...
                                <div class="sm:order-1 flex h-7 text-black px-3">
                                    <button class="flex items-center justify-center rounded-l-sm bg-pink-300 px-4 transition hover:bg-pink-500 hover:text-white">-</button>
                                    <div class="flex w-full items-center justify-center bg-gray-100 px-4 text-xs uppercase transition">1</div>
                                    <button class="flex items-center justify-center rounded-r-sm bg-pink-300 px-4 transition hover:bg-pink-500 hover:text-white">+</button>
                                </div>
                            </div>
                        </div>
                    </div>
